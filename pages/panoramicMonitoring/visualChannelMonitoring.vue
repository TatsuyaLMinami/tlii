    ...
    <div>
        ...
        >
            <span
                ...
                ><a class="download" :href="downloadhttp" download=""
                    >控件未加载，请使用IE、360或者QQ的兼容模式，若未安装请点击下载，安装完成后，启用插件设置刷新页面生效&nbsp;&nbsp;</a
                ></span
            >
            <div id="_divPlugin" class="divPlugin"></div>
    ...
    methods: {
        loadNode(node, resolve) {
            if (node.level === 0) {
                ...
                $axios({
                    url: "/tpiim/passageway/getPassagewayTreeList",
                    type: "post",
                    data: {
                        objType: objType,
        ...
        initPlugin() {
            ...
            WebVideoCtrl.I_InitPlugin(this.iWidth, this.iHeight, {
                ...
                cbInitPluginComplete: function () {
                    WebVideoCtrl.I_InsertOBJECTPlugin("_divPlugin");
            ...
            WebVideoCtrl.I_Login(
                ...
                this.Password,
                {
                    success: function (xmlDoc) {
                        ...
                        that.getChannelInfo();
                        that.initPlay(szDeviceIdentify);
                    },
                    error: function () {
