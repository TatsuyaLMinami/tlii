...
export default {
  ...
  methods: {
    ...
    loadTowerLineFn() {
      if (process.client) {
        $axios({
          url: "/resource/indexEquipment/getLineLayer",
          type: "get"
        })
          .then(res => {
            let features = [];
    ...
    initPopupFn() {
      ...
      vm.map.on("click", "towerPointGood", function(e) {
        let features = e.features[0];
        $axios({
          url: "/resource/indexStatus/getCountByTowerId",
          type: "post",
          data: {
  ...
  watch: {
    $route() {
      this.loadTowerPointFn({
        url: "/resource/indexEquipment/getTowerLayer",
        type: "get"
      }).then(res => {
  ...
  created() {
    ...
    //作业图层-人
    this.loadTowerPointFn({
      url: "/resource/indexTask/getTodayTaskLayer",
      type: "get",
      data: {
        mode: "artificial"
      }
    ...
    //状态图层-有缺陷
    this.loadTowerPointFn({
      url: "/resource/indexStatus/getTodayMarkTowerLayer",
      type: "get"
    }).then(res => {
    ...
    //状态图层-无缺陷
    this.loadTowerPointFn({
      url: "/resource/indexStatus/getTodayNormalTowerLayer",
      type: "get"
    }).then(res => {
    ...
    //专题-三跨
    this.loadTowerPointFn({
      url: "/resource/indexTopic/getSpanLayer",
      type: "get",
      data: {
        mode: "nb"
      }
    ...
    //专题-施工点
    this.loadTowerPointFn({
      url: "/resource/indexTopic/getConstructionPointLayer",
      type: "get"
    }).then(res => {
